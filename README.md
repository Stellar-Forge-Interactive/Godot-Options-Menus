# Notice
This is a repack of [Maaack's Options Menu](https://github.com/Maaack/Godot-Options-Menus) intended to be used as a submodule. This is not our original work.
...
2. run `$ git submodule add https://github.com/Stellar-Forge-Interactive/Godot-Options-Menus.git`
